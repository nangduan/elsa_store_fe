...
mixin _$ProductVariantState {
  ProductVariantStatus get status => throw _privateConstructorUsedError;
...
abstract class $ProductVariantStateCopyWith<$Res> {
  factory $ProductVariantStateCopyWith(
    ...
    $Res Function(ProductVariantState) then,
...
class __$$InitialImplCopyWithImpl<$Res>
    extends _$ProductVariantStateCopyWithImpl<$Res, _$InitialImpl>
...
class _$InitialImpl implements _Initial {
  const _$InitialImpl({
    this.status = ProductVariantStatus.initial,
    final List<ProductVariantResponse> variants = const [],
    this.errorMessage,
  }) : _variants = variants;
  ...
  @override
  String toString() {
    return 'ProductVariantState(status: $status, variants: $variants, errorMessage: $errorMessage)';
  }
...
abstract class _Initial implements ProductVariantState {
  ...
  @override
  ProductVariantStatus get status;
  @override
  List<ProductVariantResponse> get variants;
  @override
