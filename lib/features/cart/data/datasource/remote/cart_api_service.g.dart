...
class _CartApiService implements CartApiService {
  ...
  @override
  Future<ApiResponse> getCart(int userId) async {
  ...
  @override
  Future<ApiResponse> addItem(int userId, AddCartItemRequest body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'userId': userId};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse> deleteItem(int itemId, int userId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'userId': userId};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
